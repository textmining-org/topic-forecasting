...
parser.add_argument('--num_training_clusters', type=int, default=10)
parser.add_argument('--cluster_dir', type=str, default='/Data2/yejin/blockchain_data/patents_co10/clusters.max_structured.time_split')
parser.add_argument('--topic_dir', type=str, default='/Data2/yejin/blockchain_data/patents_co10/4.topic.max_structured')
